export default class TestBattleScene extends Phaser.Scene {
  ...
  setupBattleArea() {
    ...
    // Базы
    this.baseLeft = this.add.image(pBaseX + 5, pBaseY, 'baseLeft').setOrigin(0.5).setScale(1).setDepth(11);
    this.baseLeft = this.add.image(pBaseX - 15, pBaseY - 30, 'baseLeft2').setOrigin(0.5).setScale(1).setDepth(12);
    this.baseLeft = this.add.image(pBaseX -25, pBaseY + 3, 'baseLeft3').setOrigin(0.5).setScale(1).setDepth(13);
    this.baseRight = this.add.image(eBaseX -7, eBaseY + 3, 'baseRight').setOrigin(0.5).setScale(1).setDepth(11);
    this.baseRight = this.add.image(eBaseX + 5, eBaseY - 30, 'baseRight2').setOrigin(0.5).setScale(1).setDepth(12);
    this.baseRight = this.add.image(eBaseX + 25, eBaseY + 3, 'baseRight3').setOrigin(0.5).setScale(1).setDepth(13);
